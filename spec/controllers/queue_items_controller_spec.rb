...
describe QueueItemsController do 
  ...
  describe "POST create" do
    ...
    it "does not add the video to the queue if that video is already in the queue" do
      alice = Fabricate(:user)
      session[:user_id] = alice.id
      monk = Fabricate(:video)
      Fabricate(:queue_item, video: monk, user: alice)      
  ...
  describe "DELETE destroy" do
    ...
    it "does not delete the queue time if the queue item is not in the current user's queue" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      session[:user_id] = alice.id
  ...
  describe "POST update_queue" do
    ...
    context "with unauthenticated users" do
      it "redirects to th e sign in path" do
